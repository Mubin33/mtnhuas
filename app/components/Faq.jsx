...
const FAQS = [
    ...
    },
    {
        ...
        answer: "Our primary engineering hub is in  Denver, Philippines, providing a highly skilled talent pool at a competitive cost advantage. We also maintain satellite offices in London and New York for client management and solution architecture."
    },
    {
...
const FAQItem = ({ question, answer }) => {
    ...
    return (
        <div className="border-b border-slate-200/60 last:border-0">
            ...
            >
                <span className={`text-xl md:text-2xl font-bold transition-colors ${isOpen ? 'text-[#83a1cb]' : 'text-slate-900 group-hover:text-slate-700'}`}>
                    {question}
                </span>
                <span className={`ml-6 shrink-0 w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 ${isOpen ? 'bg-[#83a1cb] text-white rotate-45' : 'bg-white border border-slate-200 text-slate-400 group-hover:border-blue-200 group-hover:text-[#83a1cb]'}`}>
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                    <div className="lg:col-span-4 lg:sticky lg:top-32 self-start">
                        <span className="text-[#83a1cb] font-bold text-xs uppercase tracking-[0.5em] mb-4 block">Knowledge Base</span>
                        ...
                        >
                            Still have questions? <span className="ml-2 text-[#83a1cb] group-hover:underline">Contact Sales</span>
                        </Link>
                    </div>
