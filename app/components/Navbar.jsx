                ...
                <div className={`w-full transition-all duration-700 ease-out rounded-full ${mounted && scrolled
                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <div className="hidden lg:flex items-center space-x-2 ml-auto">
                            {navLinks.map((link) => (
                                <Link
                                    ...
                                    className={`px-4 py-4 font-medium transition-all duration-200 text-sm tracking-wide rounded-full ${scrolled
                                        ? 'text-slate-700 hover:text-[#83a1cb] hover:bg-slate-100'
                                        : 'text-slate-700 hover:text-[#83a1cb] hover:bg-white/10'
                                        }`}
                                >
                                    {link.name}
                                </Link>
                            ...
                            <Link
                                href="/contact"
                                className="flex items-center px-6 py-2.5 rounded-full font-semibold text-sm tracking-wide text-white bg-[#83a1cb] hover:bg-[#569dff] transition-all duration-300 shadow-lg shadow-purple-500/20 ml-4"
                            >
                                Schedule a Meeting
                            </Link>
                        </div>
