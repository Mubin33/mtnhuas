...
const Footer = () => {
    return (
        <footer className="bg-slate-900 text-slate-300 py-16">
            <div className="max-w-7xl w-[95%] mx-auto px-4 md:px-0">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
                    <div className="space-y-4">
                        <div className="text-2xl font-bold text-white tracking-tight">
                            <Link href="/">
                                <img src="/logo_whit_icon_gray.svg" alt="" className="w-19" />
                            </Link>
                        </div>
                        <p className="text-sm leading-relaxed">
                            Global AI & Cloud Software Company providing enterprise-grade, secure, and scalable solutions from Philippines to the world.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            <li> Denver, CO 80202, United States</li> 
                            <li>hello@mtnhausdigital.com</li>
                            <li>720-457-3578</li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="border-t border-slate-800 mt-16 pt-8 flex flex-col md:flex-row justify-between items-center text-xs">
                    <p>© {new Date().getFullYear()} mtnhaus. All rights reserved.</p>
