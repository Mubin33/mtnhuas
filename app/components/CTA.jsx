                ...
                <div className="relative overflow-hidden bg-slate-900 rounded-[3rem] px-8 py-20 md:p-24 text-center">
                    ...
                    <div className="relative z-10 max-w-4xl mx-auto">
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
                            <Link
                                href="/contact"
                                className="w-full sm:w-auto  bg-[#83a1cb] group flex items-center justify-center px-8 py-4 rounded-full font-bold text-slate-900 transition-all shadow-lg hover:shadow-emerald-500/25"
                            >
