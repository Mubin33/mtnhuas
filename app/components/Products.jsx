...
const Products = () => {
  return (
    <>
      ...
      <section className="relative bg-slate-100 pt-20 pb-28">
      ...
      <section className="py-40 bg-white relative overflow-hidden"> 
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-6 gap-8"> 
            <div className="md:col-span-4 group relative overflow-hidden rounded-[3.5rem] bg-[#83a1cb] p-12 text-white transition-all duration-700 hover:shadow-[0_30px_60px_-15px_rgba(77,42,131,0.3)] hover:-translate-y-1">
